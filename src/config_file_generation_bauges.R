...
pth_input <- paste0("D:/1_Work/5_Bauges/Data/ULM/LAS/unnorm/plots/15m_rad/may2021/allpoints/")
xml_template <- read_xml("D:/1_Work/5_Bauges/voxelisation/Results/74/template_bauges.xml")

lasfiles <- list.files(paste0("D:/1_Work/5_Bauges/Data/ULM/LAS/unnorm/plots/15m_rad/may2021/allpoints/"))


allpcnames <- as.data.table(list.files(paste0("D:/1_Work/5_Bauges/Data/ULM/LAS/unnorm/plots/15m_rad/may2021/allpoints/"), 
...
for(row in 1:nrow(allpcnames))
{
  ...
  ls <- readLASheader(paste0("D:/1_Work/5_Bauges/Data/ULM/LAS/unnorm/plots/15m_rad/may2021/allpoints/", 
                             allpcnames$grp[row],
                             ".las"))
  
  pth2 <- paste0("D:/1_Work/5_Bauges/Voxelisation/Results/74/may2021/voxfiles/allpoints/", 
  ...
  out <- paste0("D:/1_Work/5_Bauges/Voxelisation/Results/74/may2021/xmlfiles/allpoints/",
